...
angular.module('app')
    ...
    .controller('TablesController', function ($scope, storageService, tableData) {
    ...
    .controller('TableController', function ($scope, $routeParams, storageService, tablePagerNotification, tableData) {
