angular.module('app')
    ...
    .controller('PerfCounterController', ['$scope', '$routeParams', 'perfCounterService', 'deploymentsService', function($scope, $routeParams, perfCounterService, deploymentsService) {
