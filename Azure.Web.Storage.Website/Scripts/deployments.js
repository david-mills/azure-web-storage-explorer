...
angular.module('app')
    ...
    .controller('DeploymentsController', ['$scope', '$location', 'deploymentsService', 'routeData', '$cookies', function ($scope, $location, deploymentsService, routeData, $cookies) {
    ...
    .controller('DeploymentController', ['$scope', '$routeParams', 'deploymentsService', function ($scope, $routeParams, deploymentsService) {
